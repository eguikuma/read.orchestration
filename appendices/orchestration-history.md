...
# appendix：コンテナオーケストレーションの歴史

## はじめに

[01-orchestration](../01-orchestration.md) では、コンテナオーケストレーションの必要性と、Google の Borg から Kubernetes が生まれた背景を学びました
...
1. [年表](#年表)
2. [Google Borg と Omega](#google-borg-と-omega)
3. [Apache Mesos](#apache-mesos)
4. [Docker Swarm](#docker-swarm)
5. [HashiCorp Nomad](#hashicorp-nomad)
6. [なぜ Kubernetes が標準となったか](#なぜ-kubernetes-が標準となったか)
7. [オーケストレーション技術の進化の流れ](#オーケストレーション技術の進化の流れ)
8. [用語集](#用語集)
9. [参考資料](#参考資料)
...
[01-orchestration](../01-orchestration.md) では、Borg から Kubernetes への流れを概観しました
...
### Borg と Omega から Kubernetes への教訓
...
## なぜ Kubernetes が標準となったか

[01-orchestration](../01-orchestration.md) でも触れましたが、ここではこれまで見てきた他のオーケストレーション技術との比較を踏まえて、Kubernetes が標準となった理由をより深く整理します
