...
### <strong>「あるべき状態」の考え方を軸に学ぶ</strong>
...
### <strong>1. オーケストレーションの仕組みを理解する</strong>
...
### <strong>2. シリーズ全体の知識を統合する</strong>
...
### <strong>3. アプリケーション開発への橋渡し</strong>
...
| 順番 | トピック                                                 | 学ぶこと                                               |
| ---- | -------------------------------------------------------- | ------------------------------------------------------ |
| 01   | [orchestration](./01-orchestration.md)                   | なぜ Compose では足りないか、複数マシン管理の課題      |
| 02   | [architecture](./02-architecture.md)                     | コントロールプレーンとノード、「あるべき状態」の仕組み |
| 03   | [scheduling](./03-scheduling.md)                         | Pod の配置、リソース要求と制限、ノード選択の仕組み     |
| 04   | [service-discovery](./04-service-discovery.md)           | コンテナ間の発見、Service と DNS による名前解決        |
| 05   | [self-healing](./05-self-healing.md)                     | あるべき状態と実際の状態の差分検知、自動復旧           |
| 06   | [scaling](./06-scaling.md)                               | 水平スケーリング、メトリクスに基づく自動スケール       |
| 07   | [declarative-management](./07-declarative-management.md) | マニフェスト、宣言的 vs 命令的、全体の統合             |
